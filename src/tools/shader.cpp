...
Shader::Shader(std::string const& vertexPath, std::string const& fragmentPath)
{
    ...
    {
        std::cout << "ERROR::SHADER::FILE_" << vertexPath << "_" << fragmentPath << "_NOT_SUCCESSFULLY_READ: " << e.what() << std::endl;
    }
...
Shader::Shader(std::string const& folder, std::string vertexPath, std::string fragmentPath)
{
